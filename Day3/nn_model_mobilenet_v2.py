...
class GoogLeNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = self.conv_block(3, 64, 7, 2, 3)
        self.maxpool1 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)

        self.conv2 = self.conv_block(64, 64, 1)
        self.conv3 = self.conv_block(64, 192, 3, padding=1)
    ...
    def conv_block(self, in_channels, out_channels, kernel_size=3, stride=1, padding=0):
...
writer = SummaryWriter("logs/googlenet")
