...
def load_data(txt_path, img_path, is_train=True):
    """
    加载数据集函数
    :param txt_path: 图像路径和标签的文本文件路径
    :param img_path: 图像存储文件夹路径
    :param is_train: 是否为训练集，默认为 True
    :return: 数据集
    """
    ...
    dataset = ImageTxtDataset(txt_path, img_path, data_transform)
    return dataset


train_data = load_data(r"D:\dataset\train.txt", r"D:\dataset\image2\train", is_train=True)
test_data = load_data(r"D:\dataset\train.txt", r"D:\dataset\image2\train", is_train=False)
